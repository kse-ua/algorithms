...
В цьому репозиторії зібрані загальні правила здачі, завдання та посилання на матеріали курсу "Алгоритми та структури даних".
...
3. Шість групових практичних робіт.
4. Мід-терм екзамен та фінальний екзамен
...
5. Створіть репозиторій на гітхаб для цієї роботи перейшовши за посиланням у [табличці нижче](https://github.com/kse-ua/algorithms#%D1%81%D0%BF%D0%B8%D1%81%D0%BE%D0%BA-%D0%BF%D1%80%D0%B0%D0%BA%D1%82%D0%B8%D1%87%D0%BD%D0%B8%D1%85-%D0%B7%D0%B0%D0%B2%D0%B4%D0%B0%D0%BD%D1%8C).
...
2. Роботи, залиті на гіт одним комітом, формально поділені на коміти шляхом заливання шматків готового коду, або залиті через веб-інтерфейс не приймаються. Робота з системою контролюі версій - важлива навичка для розробника.
3. Якщо хтось з членів команди не має комітів у репозиторії, то він не зможе набрати бали за цю роботу. Навіть якщо ви змушені працювати за одним комп'ютером, ви можете створити [два акаунти у git](https://medium.com/@pinglinh/how-to-have-2-github-accounts-on-one-machine-windows-69b5b4c5b14e).
4. Ви можете кориcтуватися як командним рядком для роботи з git, так і обрати собі зручний клієнт.
5. Кожен член команди має володіти всім матеріалом та розуміти код всієї роботи.
...
|--:|------------------------------------------------------------------------|-----------------:|--------------------------|--------------------------|
| 1 | [Стеки, черги та калькулятор](https://classroom.github.com/a/u2EN_sM4) |            8(+2) | | |
| 2 | [Doodle Maps та пошук шляхів](./assignments_2023/assignment_2.md)      |            8(+2) | | |
| 3 | [Хеші, списки та словники](./assignments_2023/assignment_3.md)         |            8(+2) | | |
| 4 | [Жадібність та шифрування](./assignments_2023/assignment_4.md)         |            8(+6) | |   |
| 5 | [Можливо, ви мали на увазі..?](./assignments_2023/assignment_5.md)     |                8 |  |  |
| 6a | [Розділяй, володарюй, перемножуй](./assignments_2023/assignment_6.md) |            8(+1) | |  |
| 6b | [Магазини, дерева та геометрія](./assignments_2023/assignment_7.md)   |            8(+1) |  |  |
