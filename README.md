...
|---:|-------------|----:|---------------|---------------|
|1|[Стеки, черги та калькулятор](./assignments_2021/assignment_1.md)|8(+2)|||
|2|Doodle Maps та пошук шляхів|8(+2)|||
|3|Хеші, списки та словники|8(+2)|||
|4|Біоінформатика та динамічне програмування|8(+2)|||
|5|Індивідуальний проект|4(+8)|||
