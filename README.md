...
|6|[Магазини, дерева та геометрія](./assignments_2021/assignment_6.md)|8(+2)|5.05 |17.05|
...
Зауважте, що починаючи з практичної роботи 6, дедлайном вважається не 23:59 зазначенного дня, а момент початку відповідного практичного заняття. Якщо за якоїсь заняття у зазначений день відсутнє, дедлайном вважається кінець зазначеного у таблиці дня.
